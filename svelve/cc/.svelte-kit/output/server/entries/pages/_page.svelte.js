import { f as attr_style, b as attr_class, e as ensure_array_like, c as escape_html, d as bind_props, a as attr, h as stringify, i as derived, j as head } from "../../chunks/index2.js";
...
function ProductCard($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    const discountPercent = derived(() => hasDiscount() ? Math.round((1 - product.price / product.originalPrice) * 100) : 0);
    const imageUrl = derived(() => product.image_primary || product.images?.[0] || "");
    const formatPrice = (p) => {
